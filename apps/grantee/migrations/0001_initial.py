    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_1', models.CharField(max_length=1024, verbose_name='\u0424\u0430\u043a\u0442\u0438\u0447\u0435\u0441\u043a\u0438\u0439 \u0430\u0434\u0440\u0435\u0441')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(to='grantee.Organization')),
            ],
        ),
        migrations.AddField(
            model_name='contactdetails',
            name='organization',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='grantee.Organization'),
        ),
    ]
