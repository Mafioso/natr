...
class Notification(models.Model):
	...
	COROLLARY_NOTIFS = (
		COROLLARY_TO_REWORK, COROLLARY_TO_APPROVE, COROLLARY_DIR_CHECK, COROLLARY_APPROVED
	)

	COROLLARY_NOTIFS_CAPS = (
		u'Заключение отправлено на доработку',
		u'Заключение отправлено на согласование руководством',
		u'Заключение согласовано, и отправлено на утверждение',
		u'Заключение утверждено'
	)

	NOTIF_TYPES_CAPS = zip(
		() + MILESTONE_NOTIFS + MONITORING_NOTIFS +  ANNOUNCEMENT_PROJECTS_NOTIFS +  ANNOUNCEMENT_USERS_NOTIFS + ATTACHMENT_NOTIFS + COROLLARY_NOTIFS,
		() + MILESTONE_NOTIFS_CAPS + MONITORING_NOTIFS_CAPS + ANNOUNCEMENT_PROJECTS_NOTIFS_CAPS + ANNOUNCEMENT_USERS_NOTIFS_CAPS + ATTACHMENT_NOTIFS_CAPS + COROLLARY_NOTIFS_CAPS,
	)
