...
class Notification(models.Model):
	...
	NOTIF_TYPES_CAPS = zip(
		() + MILESTONE_NOTIFS + MONITORING_NOTIFS +  ANNOUNCEMENT_PROJECTS_NOTIFS +  ANNOUNCEMENT_USERS_NOTIFS + ATTACHMENT_NOTIFS,
		() + MILESTONE_NOTIFS_CAPS + MONITORING_NOTIFS_CAPS + ANNOUNCEMENT_PROJECTS_NOTIFS_CAPS + ANNOUNCEMENT_USERS_NOTIFS_CAPS + ATTACHMENT_NOTIFS_CAPS
	)
