...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('projects', '0002_auto_20151118_0630'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='project',
            name='fundings',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=None, max_digits=20, blank=True, null=True, default_currency=b'KZT'),
        ),
        migrations.AlterField(
            model_name='project',
            name='own_fundings',
