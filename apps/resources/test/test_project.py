...
#        utils.pretty(data)
    ...
    def test_create_project_hotfix_document_agreement(self):
        ...
        self.assertEqual(data['number_of_milestones'], response_data['number_of_milestones'])
        self.assertEqual(data['name'], response_data['name'])
        self.assertIn('aggreement', response_data)
        self.assertIn('id', response_data['aggreement'])
        self.assertTrue(response_data['aggreement']['id'] > 0)
